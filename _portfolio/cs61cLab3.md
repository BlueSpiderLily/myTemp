...
![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv2.PNG)
...
![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv3.PNG)
...
First though, we must open the respective file, "fib.s" in our project folder.
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv4.PNG)
  >0x000002B3
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv5.PNG)
  >0x00000073
...
On the right side of our screen we also have a "registers" tab, which we can use to see all 32 bit registers.
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv6.PNG)
  >0x7FFFFFE0

We're asked to continue stepping until the value in the register 't1' changes. Our initial value is:
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv7.PNG)
  >0x00000000
...
At offset 0x8 we see the change:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv8.PNG)
  >0x00000001
...
It's also asking for the machine code of the current instruction:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv9.PNG)
  >0x10000E17
...
Stepping until offset 0x10, we're then asked:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv10.PNG)
  >0x10000000
...
We're also asked what it points to, and we can see this instruction says "lw x28 0(x28)", the 0(x28) is key to me showing a dereference of an address. So lets take its address and find what it points to.
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv11.PNG)
  >0C
...
Next, we're asked to set a breakpoint on offset 0x28, and find the value in the t0 register.
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv12.PNG)
  >0x00000001

Stepping into the loops breakpoint six more times like asked, we need to find the new value of the t0 register.
  + Question 8: What is the value of the t0 register? The answer should be a 32 bit hexadecimal number, with the 0x prefix.
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv13.PNG)
  >0x0000000D
...
Now we're asked to change from hexadecimal and read the decimal value:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv14.PNG)
  >13
...
Running the program until it finishes we're lastly asked:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv15.PNG)
  >144
...
After running the program, it looks like we're running into an error message, and asked to:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv16.PNG)
  >0x10008058
...
Seeming like a memory error, we go ahead and turn on memcheck in Venus editor to get more details.
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv17.PNG)
  >0x10008080
...
Trying to debug this error and recalling that register t1 contains the loop counter we're asked:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv18.PNG)
  >11
...
After running our program again, we're asked:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv19.PNG)
  >40
...
Now we're asked to run memcheck in verbose mode:
  ...
  ![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv20.PNG)
...
![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv21.PNG)
...
Testing 8!
![](https://raw.githubusercontent.com/BlueSpiderLily/myTemp/refs/heads/master/images/risc/riscv22.PNG)
>40320 :)
